...
const AllProject = () => {
  ...
  return (
    <div className="section projects-section mx-4 md:mx-10 lg:mx-14 mb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20 auto-rows-fr">
        {project?.map((proj) => (
          <Zoom key={proj._id}>
            <div className="flex flex-col h-full bg-base-100 border-2 border-blue-400 hover:border-cyan-300 p-6 rounded-lg shadow-lg hover:shadow-2xl hover:shadow-cyan-200 transition-shadow duration-300">
              <div className="mb-4">
                <Image
                  src={proj.image}
                  alt="Project Image"
              ...
              <div className="mt-auto text-center flex justify-center space-x-4">
                <Link
